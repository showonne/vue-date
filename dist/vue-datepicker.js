	...
	exports.default = {
	    ...
	    computed: {
	        dateList: function dateList() {
	            ...
	            for (var _i = dateList.length, _len = 42, item = 1; _i < _len; _i++, item++) {
